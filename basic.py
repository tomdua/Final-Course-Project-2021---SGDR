...
Original file is located at
    https://colab.research.google.com/drive/1xfkf77W__Ofnm9S3VvunVMVWSB56IC1k
...
def read_data(data_name):
  path="/content/drive/MyDrive/Colab Notebooks/SGDR/final_porject_data/"+data_name
  df=pd.read_csv(path)
  # print(df.shape)
  # print(df.head())
  x,y=split_data(df)
...
import os
mylist = os.listdir('/content/drive/MyDrive/Colab Notebooks/SGDR/final_porject_data/')
best_warm={}
counter = 0
...
for element in mylist:
  ...
  for i in range (0,10):
    ...
    precision_val = list(res.values())[0][-1:]
...
def run(x,y):
  ...
  for train_index, test_index in cv_outer.split(x,y):
    ...
    for j, (train_inner_idx, val_inner_idx) in enumerate(cv_inner.split(x_train, y_train)):
      ...
      val_acc_inner[j] = (hp_search(x_train_inner, x_val_inner, y_train_inner, y_val_inner, hp[stage_name[0]], stage_name[0]))
    ...
    best_hp = hp[stage_name[0]][max_index_of_acc]
    best_train_history = train_model(x_train,y_train,x_test, y_test, best_hp, stage='basic', epochs=50)
